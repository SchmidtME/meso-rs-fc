...
% First, an rm ANOVA is computed to assess the effects of beta squares (1-2 to
% 1-2, 1-4 to 1-4, 1-6 to 1-6, 1-8 to 1-8, 1-10 to 1-10).
% Second, as a supplementary analysis, an LME is fitted to account for the 
...
for Layer = 1:length(Layers)
    ...
    String = [Label, '_layers_', Layers{Layer}, '_intrahemispheric/'];
