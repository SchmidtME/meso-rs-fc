...
% This is the analysis comparing V1 subregions. It corresponds to Figure 5 of the manuscript. 
% The data is averaged over hemispheres and distances. The first part assesses differences between 
% V1_Anterior (Peripheral V1) and V1_Posterior (Central V1).
...
Labels = {'V1_Posterior', 'V1_Anterior'}; 
...
disp('V1 Anterior vs Posterior - Effect of type, beta, layer and ROI on rs-FC - averaged over hemispheres, distances - accumulative beta')
