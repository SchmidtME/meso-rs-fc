function Data_Combined = B001a_Selectivity_Proc_Data(subName, Root, AnalysisParam, TrgFile,s)
...
selected_indices_same_eye = load(fullfile('/space/ardebil/1/users/Others/Marianna/FC_7T_Coronal/Controls/Results', [AnalysisParam.ROI '_layers_0-10_intrahemispheric'], subName, sprintf('CorrelationMtx_FC_Params_subsampled.mat'))).AnalysisParam.selected_indices_same_eye;
% TimeSeries Params
