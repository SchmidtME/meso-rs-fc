...
if save_figures:
    ...
    save_dir = f'/space/ardebil/1/users/Others/Marianna/FC_7T_Coronal/Controls/Figures/Supplementary/Figure_3/{date_stamp}'
...
baseDir = f'/space/ardebil/1/users/Others/Marianna/FC_7T_Coronal/Controls/Results/Supplementary'

layers = [
    f'{ROI}_layers_8-10_intrahemispheric_vis_resp',
    f'{ROI}_layers_4-6_intrahemispheric_vis_resp',
    f'{ROI}_layers_0-2_intrahemispheric_vis_resp'
]
