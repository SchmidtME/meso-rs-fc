...
savePath = ['/space/ardebil/1/users/Others/Marianna/FC_7T_Coronal/Controls/Figures/Figure_2/Suppl/' currentDate '/'];
if saveTables 
    mkdir(savePath);
end
    ...
    for Dist = 1:10
        for Label = 1:length(Labels)
            ...
            for Layer = 1:length(Layers)
                ...
                String = [Labels{Label}, '_layers_', XX, '_intrahemispheric_' GroupLabels{Group} '/'];
