function Data_Combined = B001a_Selectivity_Proc_Data_odc_sep_depths(subName, Root, AnalysisParam, TrgFile,s, depth)
...
selected_indices_eye1eye2 = load(fullfile(Root, sprintf('CorrelationMtx_FC_Params_subsampled_%d.mat',s))).AnalysisParam.selected_indices_eye1eye2;
selected_indices_same_eye = load(fullfile(Root, sprintf('CorrelationMtx_FC_Params_subsampled_%d.mat',s))).AnalysisParam.selected_indices_same_eye;
% TimeSeries Params
...
% if ~exist(sprintf('%s/CorrelationMtx_Selectivity_Params_subsampled.mat', Root))
%     save(sprintf('%s/CorrelationMtx_Selectivity_Params_subsampled.mat', Root), 'AnalysisParam', '-v7.3');
