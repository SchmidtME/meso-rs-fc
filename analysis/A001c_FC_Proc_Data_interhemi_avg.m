function Data_Combined = A001c_FC_Proc_Data_interhemi_avg(subName, Root, AnalysisParam, TrgFile)
...
for sessionNum = 1:length(rsSessions)
    ...
    corr_v1_patch = partialcorr(mean(rs_v1_patch{1},1)', mean(rs_v1_patch{2},1)', [mcpr(:,1:3) wm]);
...
save([Root,'/CorrelationMtxjustFC.mat'], 'Data_Combined', 'AnalysisParam');