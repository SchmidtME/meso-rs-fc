...
saveDir = "/space/ardebil/1/users/Others/Marianna/FC_7T_Coronal/Controls/Figure_3_plot_data"
...
# Save all processed arrays and metadata to a .mat file
output_path = os.path.join(saveDir, f'Figure_3_{ROI}_data.mat')
