...
normalization = '' # weighted (alike + unalike), not_weighted (overall FC), none
...
save_data_dir = "/space/ardebil/1/users/Others/Marianna/FC_7T_Coronal/Controls/Figure_S6_right_plot_data"
